        ...
        <>
            ...
            {selectedContent === 'content3' && (
                <div className="p_USRHUB-UH" style={{ fontSize: "20px", fontFamily: "Arial, sans-serif" }}>
                    ...
                    辦理活動: 地方關懷創生
                    <p></p>
                    111年整合校際資源，攜手相同理念、熱忱之中華科大、 聖約翰科大、馬偕醫護專校之原資中心共同規劃執行，四校共同設定之 14 「文化、體能、環教、衛教」等兩階段主題內容，提供給忠治部落青年及孩童更具意涵之服務，且讓服務之四校學生也能相互學習交流，並擴展人脈關係。
                    <p></p>

                    辦理活動:地方關懷創生
                    <p></p>
                    111年忠治部落，透過辦理暑期主題營隊，執行「在地關懷」、「永續環境」等政策目標外，並透過原民工作坊專題講座、樂水部落參訪交流與體驗，讓忠治部落居民及青年能有重新認識自己部落、整合自然資源、發展地方特色，以促進「地方創生」之契機，該階段服務計有部落居民、青少年、小朋友及兩校師生377人次參與。
