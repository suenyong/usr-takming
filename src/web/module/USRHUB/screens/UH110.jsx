        ...
        <>
            ...
            {selectedContent === 'content1' && (
                <div className="p_USRHUB-UH" style={{ fontSize: "20px", fontFamily: "Arial, sans-serif", }}>
                    ...
                    <p></p>
                    執行成果: AI軟體系統、區塊鏈每月設定主題舉辦論壇，7 月為 AI 商業應用、8 月為區塊鏈應用、9 月 為新零售服務、10 月為服務創新、 11 月為流通創新。共舉辦 12 場次， 參與人數 263 人。
                    <br></br>
                    (1) 20 萬資本門建置「創新育成中心」，結合校內跨院跨系師資團隊協助鄰近企業獲得政府創新資源。 
                    <br></br>
                    (2) 企業創新顧問 9 家、協助 3 企 業企業(全家便利商店股份有 限公司、中保物流股份有限公司、華宥企業有限公司)獲得政府補助款 945 萬元；產學案 5 案共計 249 萬元。
                    <br></br>
                    (3) 輔導創新廠商遊隼科技股份有限公司並進駐創新育成中心 (籌備中)。

                    <p>
                    該名計畫助理執行論壇活動，並且與業界廠商聯絡溝通，進行創新育成發想，協助計畫順利執行。
                    </p>
            ...
            {selectedContent === 'content2' && (
                ...
                <div className="p_USRHUB-UH" style={{ fontSize: "20px", fontFamily: "Arial, sans-serif" }}>
                    ...
                    <p></p>
                    執行成果: 跨境電商平台操作在行銷系、國貿系、研發處共邀請跨境電商 17 位業師協同教學，授課學生數 435 人。 
                    <p></p>
                    跨境電商平台操作、社群行銷、微電影製作
                    <br />
                    (1) 110 年 10 月 22 日至 11 月 06 日舉辦「2021 東協跨境電商行銷微電影競賽(校內)」，共 7 隊進入決賽 
                    <p/>
                    (2) 110 年 11 月 06 日舉辦校內「東協跨境電商行銷競賽暨成果發表」該名計畫助理成為與越南當地企業、學校溝通媒介橋樑，協助計畫順利執行。
                    <p>
                    計畫衍生亮點成果案例(計畫成果中可供各界參考的執行亮點或特色內容)。 計畫於110年11月06日舉辦「跨境電商行銷競賽暨成果發表會」由東南亞外籍生製作跨境電商行銷競賽，提供外籍生學術和實務交流的平台，也呼應本 USR Hub計畫主軸—數位科技支援多元族群（外籍生）的大學社會責任。計畫衍生效益則是媒合兩位外籍生到計畫合作機構企業實習，培育跨境電商人才。
                    </p>
