        ...
        <>
            ...
            {selectedContent === 'content3' && (
                <div className="p_USRHUB-UH" style={{ fontSize: "20px", fontFamily: "Arial, sans-serif" }}>
                    ...
                    「由學務處透過部落文化及生態體驗活動，讓參與服務的師生更認識新北市烏來區忠治部落原住民文化、尋回對原住民文化的認同感；透過體育及衛生教 育教學課程，讓部落居民及孩童，養成良好運動及衛生保健習慣；透過闖關及方案活動，培育孩童從小建立正確理財觀念，成為有品格的好學生；延續109 年共輔導43位部落青少年及小朋友舉辦品格教育和理財教育課程，讓本校學生透過計畫執行使學生有機會實際體驗城鄉交流服務經驗，培育未來參與社會的關懷奉獻能力，109年製成「綠色生活地圖」協助部落發展地方特色，啟發社區營造思維，協助部落找回地區文化的認同感。110年持續深耕該部落，並將偏鄉課程導入數位教材，建立永續關懷偏鄉的生命教育。」
                    <p></p>
