        ...
        <>
            ...
            {selectedContent === 'content1' && (
                <div className="p_USRHUB-UH" style={{ fontSize: "20px", fontFamily: "Arial, sans-serif", }}>
                    ...
                    數位科技應用：AI軟體系統、社群軟體
                    <p />
                    執行成果：每月舉辦主題商業創新論壇(社群電商、AI商業應用、大 數據應用、區塊鏈等)；同時開設創業系列課程及AI實作應用課程，總計共辦理24場，參與人數達503人。
                    <br></br>
                    <p></p>
                    ...
                    <p />
                     執行成果：資本門45萬元籌設創新育成中心，相關設備進駐及結 合16位跨院跨系領域師資團隊共同組成。
                    <p />
            ...
            {selectedContent === 'content2' && (
                ...
                <div className="p_USRHUB-UH" style={{ fontSize: "20px", fontFamily: "Arial, sans-serif" }}>
                    ...
                    「本校有超過400位的外籍學生，為了善盡大學之社會責任， 擬建置「外籍生生活地圖」，整合鄰近商家、導入客源，並協助外籍生在台生活便利。透過「美好電商」、「樂利跨境電商」將鄰近商家以店家類型分類，將店家資訊、商品透明化，提供外籍生使用，亦可為店家帶來人潮與商機。另外，現今網購消費力不容小覷，鄰近商家可能無法滿足外籍生需求，因此計畫與本土「美好電商」、「樂利跨境電商」合作，網站有越南文及印尼文，提供外籍生更多選擇，協助東協國家之外籍學生，在越南或印尼電商平台開設店中店創業。」
                    <p></p>
                    辦理活動：東協跨境電商業師課程實務交流
                    <p />
                    數位科技應用：跨境電商平台操作
                    <p />
                    執行成果：邀請跨境電商6位業師協同教學，結合網紅經營、電商社群、國際行銷等課程，參與學生數達363人。
                    <br></br>
                    <p></p>
                    ...
                    舉辦全國性跨境電商企劃書競賽共五校共同參與，48位各校外籍學生團隊參賽，透過行銷企劃書傳達創意。
                    全國性跨境電商實作競賽，參賽分為境內組與境外組，各三校六隊參與，透過社群行銷、網路直播等方式競賽。
                    跨境電商行銷短片競賽，共14組本校外籍學生參與，透過語言介紹、腳本撰寫、拍攝技巧等評比，多元化學習。
                    <br></br>
                    <p></p>
                    ...
                    <p />
                    計畫於109年12月22日舉辦「跨境電商行銷競賽暨成果發表會」由東南亞外籍 生製作跨境電商行銷競賽，本計畫也舉辦「2020全國大專校院跨境電商競賽」共全國五校外籍生參加，提供外籍生學術和實務交流的平台，也呼應本USR Hub計畫主軸—數位科技支援多元族群（外籍生）的大學社會責任。計畫衍生效益則是媒合兩位外籍生到計畫合作機構企業實習，培育跨境電商人才。
                    <p></p>
            ...
            {selectedContent === 'content3' && (
                <div className="p_USRHUB-UH" style={{ fontSize: "20px", fontFamily: "Arial, sans-serif" }}>
                    ...
                    「由學務處透過部落文化及生態體驗活動，讓參與服務的師生更認識新北市烏來區忠治部落原住民文化、尋回對原住民文化的認同感；透過體育及衛生教 育教學課程，讓部落居民及孩童，養成良好運動及衛生保健習慣；透過闖關及方案活動，培育孩童從小建立正確理財觀念，成為有品格的好學生。<p />延續109 年共輔導43位部落青少年及小朋友舉辦品格教育和理財教育課程，讓本校學生透過計畫執行使學生有機會實際體驗城鄉交流服務經驗，培育未來參與社會的關懷奉獻能力，109年製成「綠色生活地圖」協助部落發展地方特色，啟發社區營造思維，協助部落找回地區文化的認同感。110年持續深耕該部落，並將偏鄉課程導入數位教材，建立永續關懷偏鄉的生命教育。」
                    <p></p>
