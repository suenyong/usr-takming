    ...
    <>
        ...
        <div className="PushCore">
            <div class="text-content">
                  ...
                  落區民和本校外籍生，校內整合跨院系師生資源，透過數位科技協助多元族群發展 ，善盡大學社會責任（圖1）。計
                  畫實質內涵符合校務發展主軸二（健全品格教育、善盡社會責任）和主軸 三（鏈結產學合作、深耕研究務實），並
                  結合校務發展目標之產業需求和加強產學鏈結。實現「進步優質學府、業界最愛科大」的學校願景。本校鄰近內湖
                  科技和南港軟體園區，中小企業有轉型升級上需求，以 及本校近500位越南生需要積極培力與時俱進的技能，最後
                  學校長期深耕新北市烏來鄉忠 治部落協助部落 青年正確人生觀。在 109-111 年執行 USR Hub 計畫：數位科技
                  支 援多元族群計畫，緊扣中程發展計畫 與教育部高教深耕計畫目 標的推動，實施場域對象涵蓋多元族群（企業
                  、越南生和原民部落），以數位科技支援多元族群發展。計畫目標是整合跨院系師生資源，以及連結校務發展主軸
                  二（健全品格教育、善盡社 會責任）和主軸三（鏈結產學合作、深耕研究務實），實現「進步優質學府、業界最愛
                  科大」的學校願景， 透過數位科技協助多元族群發展，善盡大學社會責任。
                  </p>
                  <div class="title_Usr"><p>USR</p></div>
                  <p>
                    內湖金面山在地風華–永續實踐計畫，依循 USR 推動目標以「人才培育」和「在地鏈結」為核心，透過設
                    計思考以人為本的設計精神，從在地需求出發， 將實踐場域鎖定在學校在地之內湖金面山、西湖商圈以及
                    白石湖休閒農業區， 除與本校有著深切地緣關係外，內湖金面山雖擁有豐富的人文與自然資源且為 小百岳
                    之一，但是知名度卻鮮為人知，且缺乏在地導覽機制與人才。而金面山山腳下的西湖商圈以及白石湖休閒農
                    業區，同樣面臨著有著良好的商家但觀光 人潮有待提升的困境，缺乏在地特色與商圈的連結，也缺乏多樣性
                    的在地旅遊體驗行程規劃。面對這些問題與挑戰，本計畫希望利用金面山的人文、自然生態與小百岳的優勢
                    ，串聯西湖商圈與白石湖的觀光，透過「樂活與創生跨領域 學分學程」課程規劃，師生增能的共學形式，實
                    踐在地關懷的大學社會責任，落實具有在地文化色彩的永續旅遊發展，計畫目標對焦 SDGs4 優質教育與 SDGs11 
