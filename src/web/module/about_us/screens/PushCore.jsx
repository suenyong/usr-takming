      ...
      <div className="PushCore">
        <div class="text-content">
          ...
          <p>
            ...
            落區民和本校外籍生，校內整合跨院系師生資源，透過數位科技協助多元族群發展
            ，善盡大學社會責任（圖1）。計
            畫實質內涵符合校務發展主軸二（健全品格教育、善盡社會責任）和主軸
            三（鏈結產學合作、深耕研究務實），並
            結合校務發展目標之產業需求和加強產學鏈結。實現「進步優質學府、業界最愛科大」的學校願景。本校鄰近內湖
            科技和南港軟體園區，中小企業有轉型升級上需求，以
            及本校近500位越南生需要積極培力與時俱進的技能，最後
            學校長期深耕新北市烏來鄉忠 治部落協助部落 青年正確人生觀。在 109-111
            年執行 USR Hub 計畫：數位科技 支 援多元族群計畫，緊扣中程發展計畫
            與教育部高教深耕計畫目 標的推動，實施場域對象涵蓋多元族群（企業
          ...
          <p>
            ...
            將實踐場域鎖定在學校在地之內湖金面山、西湖商圈以及
            白石湖休閒農業區，
            除與本校有著深切地緣關係外，內湖金面山雖擁有豐富的人文與自然資源且為
            小百岳
            之一，但是知名度卻鮮為人知，且缺乏在地導覽機制與人才。而金面山山腳下的西湖商圈以及白石湖休閒農
            業區，同樣面臨著有著良好的商家但觀光
            人潮有待提升的困境，缺乏在地特色與商圈的連結，也缺乏多樣性
            的在地旅遊體驗行程規劃。面對這些問題與挑戰，本計畫希望利用金面山的人文、自然生態與小百岳的優勢
            ，串聯西湖商圈與白石湖的觀光，透過「樂活與創生跨領域
            學分學程」課程規劃，師生增能的共學形式，實
        ...
        <div class="container">
          ...
          <div class="conversation11">
            ...
            <div class="text">
              ...
              德明甘丹內科園區永續時尚實踐計畫的場域為內湖科學園區，地價昂貴，部分紡織企業將公司場所堆放庫存布，逐年增加負擔，處理方式並不環保，因此若能將庫存布捐贈並回收製作該企業的制服並給予回饋機制，或是提供制服給園區內的餐廳使用，除了讓庫存布料有了循環機會，也可以培養園區內民眾的永續概念。本計畫預計於113年執行【全回收】計畫，可將永續經營的概念提高到另一層次，達到搖籃到搖籃的技術循環(technical
              cycle)，採用100%寶特瓶回收的布料、紗線與拉鍊。計畫與新光紡織公司ISP計畫配合，從制服回收，纖維融化抽絲、織布染整、成衣設計與製作，進行閉鎖式的循環。透過解決園區內紡織企業庫存布料的痛點，建置永續時尚設計循環與庫存布料實體平台與台灣綠色紡織品聯盟，提供高中職、新銳設計師免費布料與園區廠商免費制服並重複使用的永續經營模式，預期架構一個可複製於全台灣地區的USR模式，並計畫於113年進行國際服飾品牌庫存布合作計畫，達成共同落實SDGs的目標。為在地問題解決構想與發展計畫，重視精進跨領域課程與深化實踐場域，鼓勵跨校合作但不強制，以「人才培育」為執行主軸，且須開設專業課程，獲核定補助計畫之學校進行計畫成效評估之規劃，並出版大學社會責任年報。跨域教學創新、人才培育、場域永續發展、價值創造。
            </div>
          </div>
        </div>
      </div>
