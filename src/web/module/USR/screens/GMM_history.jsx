...
export default function GMM_history() {
    return (
        <>
            ...
            <div className="Gbox">
                <img src={require("..//images/路線圖.png")} className="Map"></img>
                <div >
                    ...
                    <div className="Road_2">喜歡挑戰的遊客可以選擇比較有難度的大岩壁(黃色路線)</div>
                    <div className="Road_2">喜歡輕鬆休閒或是帶小朋友的可以選擇(藍色路線)</div>
                </div>
            </div>
            ...
            <div className="Gbox">
                <div className="Content">
                    <div className="GMM_Mtitle">打石場</div>
                ...
                <div className="Content">
                    <div className="GMM_Mtitle">大壁岩</div>
                    <div className="GMM_box">
                ...
                <div className="Content">
                    <div className="GMM_Mtitle">大金面山(剪刀石)</div>
                    <div className="GMM_box">
