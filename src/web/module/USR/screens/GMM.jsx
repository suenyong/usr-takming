        ...
        <>
            ...
            <div className="contain-GMM">
                ...
                <div className="image_box">
                    ...
                    <div className="GMM_text2">
                        ...
                        依循 USR 推動目標以「人才培育」和「在地鏈結」為核心，透過設計思考以人為本的設計精神，從在地需求出發，將實踐場域鎖定在學校在地之內湖金面山、西湖商圈以及白石湖休閒農業區， 除與本校有著深切地緣關係外，內湖金面山雖擁有豐富的人文與自然資源且為小百岳之一，但是知名度卻鮮為人知，且缺乏在地導覽機制與人才。而金面山 山腳下的西湖商圈以及白石湖休閒農業區，同樣面臨著有著良好的商家但觀光人潮有待提升的困境，缺乏在地特色與商圈的連結，也缺乏多樣性的在地旅遊體驗行程規劃。面對這些問題與挑戰，本計畫希望利用金面山的人文、自然生態與小百岳的優勢，串聯西湖商圈與白石湖的觀光，透過「樂活與創生跨領域 學分學程」課程規劃，師生增能的共學形式，實踐在地關懷的大學社會責任， 落實具有在地文化色彩的永續旅遊發展，計畫目標對焦 SDGs4 優質教育與 SDGs11 永續城市及社區，以培育學生具備跨領域及解決問題的能力及永續樂活 人才，達成在地活化與永續社區發展之目標。
                    </div>
                </div>
            </div>
            {/* ==================================================================== */}
            <div className="contain2nd">
                ...
                <div className="boxNeed">
                    位於台北市內湖區金面山山腳下有著西湖商圈以及同屬五指山系的白石湖休閒農業區，同樣面臨著有著良好的商家但是觀光人潮卻有待提升的困境，由於缺乏在地特色與商圈的連結，也缺乏多樣性的在地旅遊體驗行程規劃。因此，針對西湖商圈與白石湖休閒農業區問題，希望利用金面山的人文、自然生態與小百岳的優勢，串聯西湖商圈與白石湖的觀光，規劃「創意遊程」與「商圈共榮」兩大主題的創意課群，藉由大學「資訊、數位行銷與創意」專長，由師生深入場域探查瞭解地方需求與具開發潛力的在地特色，協助發展金面山遊憩樂活議題，同時帶動西湖商圈與白石湖休閒農業區的觀光人潮，並藉此培養學生認識在地，激發對內湖在地的認同情感，進而推動以金面山為主的人文知性與觀光行程，形塑永續樂活態度，進而打造金面山樂活圈，推行永續漫活商圈與白石湖共榮共利的前景。
                    本計畫期望藉由師生增能的共學形式，實踐在地關懷的大學社會責任，落實具有在地文化色彩的永續旅遊發展可能並將計畫目標對焦於SDGs當中的 SDGs4：優質教育，透過「樂活與創生跨領域學分學程」培育學生具備跨領域及解決問題的能力，並與地方共同培育在地所需之人才；SDGs11：永續城市與社區，以學校資訊能量協助建構「綠活數位地圖」，每年舉辦「金面山樂活走讀感恩祭」以數位化讓社區與商家共同參與具代表性感恩祭市集，達成在地活化與永續發展。
                </div>
