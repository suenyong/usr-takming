    ...
    return (
        <>
            ...
            <div className="boxHistory">
                ...
                金面山至今還保留有「清代採石場」的古蹟遺址，是《清光緒8年(1882年)》所設立的，目前已經由台北市政府指定為市定古蹟。金面山海拔雖僅258公尺，但在山頂巨岩登高望遠，大台北盆地風光盡收眼底，一面可俯瞰山腳下蜿蜒的基隆河及 大湖、碧湖，另一面俱是蒼翠山丘綿延，感受內湖所謂的「一河二湖山多多」。
                金面山擁有豐富的人文資產與自然資源，雖為小百岳之一但是知名度卻鮮為人知。金面山親山步道最多人出發的環山路登山口即在本校德明財經科技大學旁，因地緣關係與本校密不可分，破碎化的歷史文化保存使得外地移入居民缺乏對在地的認識也缺乏在地導覽機制與人才，本校位居內湖最高學府，身負人才培育使命的大學，深耕教育善盡社會責任，具有責無旁貸的使命！
                針對金面山的歷史文化傳承題，本校以「在地鏈結」與 「人才培育」兩個主軸規劃分年逐步建構金面山的人文歷史知識的數位保存與發展，協助金面山文化傳承和創造永續樂活的白石湖社區。
            </div>

            <div className="boxPlan">
                <p style={{ textAlign: "left", fontSize: "20px", fontFamily: "Arial, sans-serif", color: 'rgb(99,182,130)', lineHeight: 0.3 }}>問題意識與計畫目標</p>
                ...
                而金面山山腳下的西湖商圈以及白石湖休閒農業區，同樣面臨著有著良好的商家但觀光人潮有待提升的困境，缺乏在地特色與商圈的連結，也缺乏多樣性的在地旅遊體驗行程規劃。
                面對這些問題與挑戰，本計畫希望利用金面山的人文、自然生態與小百岳的優勢，串聯西湖商圈與白石湖的觀光，透過「樂活與創生跨領域學分學程」課程規劃，師生增能的共學形式，實踐在地關懷的大學社會責任，落實具有在地文化色彩的永續旅遊發展，計畫目標對焦 SDGs4 優質教育與 SDGs11 永續城市及社區，以培育學生具備跨領域及解決問題的能力及永續樂活人才，達成在地活化與永續社區發展之目標。
            </div>

            <h1 style={{ textAlign: "left", fontSize: "20px", fontFamily: "Arial, sans-serif", color: 'rgb(99,182,130)', lineHeight: 0.3, marginLeft: 115 }}>社會實踐議題(含SDGs)</h1>
            ...
            <h1 style={{ textAlign: "left", fontSize: "20px", fontFamily: "Arial, sans-serif", color: 'rgb(99,182,130)', lineHeight: 0.3, marginLeft: 115 }}>需求與改善</h1>
