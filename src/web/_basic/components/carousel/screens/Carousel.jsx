...
export default function Carousel(props){
  const [photos, setPhopos] = useState(
    [
      { id: 1, src: require("../images/ASEAN_1.jpg") },
      { id: 2, src: require("../images/ASEAN_2.jpg") },
      { id: 3, src: require("../images/SIB_1.jpg") },
      { id: 4, src: require("../images/SIB_2.jpg") },
      { id: 5, src: require("../images/TLTS_1.jpg") },
